...
Mapp all reads from a MinION dataset to a reference genome (lambda) to identify and remove spiked data. Create a new fastq.gz file with unmapped reads,that can be assembled using canu.
